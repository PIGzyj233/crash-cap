...
- Generated: `2026-08-24T11:47:11.852662+00:00`
- Decision: **PASS / GO**
- Passed: `13/13`
...
| --- | --- | ---: | --- |
| `markdown-links` | PASS | 0.931 | `C:\Python314\python.exe scripts/ci/check_markdown_links.py` |
| `rust-format` | PASS | 0.228 | `cargo fmt --check` |
| `rust-clippy` | PASS | 0.428 | `cargo clippy --workspace --all-targets --locked -- -D warnings` |
| `rust-tests-and-contracts` | PASS | 5.264 | `cargo test --workspace --locked` |
| `schema-matrix` | PASS | 0.491 | `C:\Python314\python.exe scripts/schema/validate.py` |
| `python-lint` | PASS | 0.069 | `uv run ruff check .` |
| `python-types` | PASS | 0.478 | `uv run mypy api worker cli` |
| `platform-tests` | PASS | 27.94 | `uv run pytest -q` |
| `ci-cli-contract` | PASS | 0.016 | `E:\ai-services\crash-cap\tools\crashcap-ci\windows-x86_64\crashcap-ci.exe --help` |
| `frontend-openapi` | PASS | 2.519 | `pnpm openapi:check` |
| `frontend-tests` | PASS | 10.309 | `pnpm test -- --run` |
| `frontend-types` | PASS | 0.483 | `pnpm lint` |
| `frontend-build` | PASS | 11.351 | `pnpm build` |
