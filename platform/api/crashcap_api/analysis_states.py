...
_TRANSITIONS: dict[str, frozenset[str]] = {
    ...
    "VALIDATING": frozenset({"INSPECTED", "REJECTED", "FAILED", "TIMEOUT", "OOM", "CANCELLED"}),
    "INSPECTED": frozenset({"MATCHING_SYMBOLS", "FAILED", "TIMEOUT", "OOM", "CANCELLED"}),
    "MATCHING_SYMBOLS": frozenset(
        {"SYMBOLS_READY", "WAITING_FOR_SYMBOLS", "FAILED", "TIMEOUT", "OOM", "CANCELLED"}
    ),
    "WAITING_FOR_SYMBOLS": frozenset({"MATCHING_SYMBOLS", "FAILED", "TIMEOUT", "OOM", "CANCELLED"}),
