...
const build: Build = {
  ...
  artifacts: [
    { id: 'art_app_pe', artifact_blob_id: 'abl_app_pe', delivery: 'uploaded', module_id: 'mod_app', kind: 'pe', logical_name: 'desktop-client.exe', sha256: '1'.repeat(64), size: 8_420_112, code_id: '67A1B9231F000', debug_id: 'b0c27c20a4704c4fa6f2b706d29f7e031', verification_status: 'verified', ingest_metadata: null, created_at: iso(60 * 8) },
    { id: 'art_app_pdb', artifact_blob_id: 'abl_app_pdb', delivery: 'reused', module_id: 'mod_app', kind: 'pdb', logical_name: 'desktop-client.pdb', sha256: '2'.repeat(64), size: 41_900_112, code_id: null, debug_id: 'b0c27c20a4704c4fa6f2b706d29f7e031', verification_status: 'verified', ingest_metadata: null, created_at: iso(60 * 8) },
    { id: 'art_render_pe', artifact_blob_id: 'abl_render_pe', delivery: 'backfilled', module_id: 'mod_render', kind: 'pe', logical_name: 'render.dll', sha256: '3'.repeat(64), size: 3_120_112, code_id: '67A1B925A1000', debug_id: '94e72158e9a3443c787b78a8a3448d0d730', verification_status: 'verified', ingest_metadata: null, created_at: iso(60 * 8) },
    { id: 'art_render_bad_pdb', artifact_blob_id: null, delivery: null, module_id: 'mod_render', kind: 'pdb', logical_name: 'render.pdb', sha256: '4'.repeat(64), size: 22_012_882, code_id: null, debug_id: '94e72158e9a3443c787b78a8a3448d0d730', verification_status: 'pdb_mismatch', ingest_metadata: null, created_at: iso(60 * 7) },
  ],
  groups: [primaryGroup],
}
