...
export function PlatformHomePage() {
  ...
  return <div className="platform-page">
    <PageTitle kicker="CRASH-CAP / PRIVATE INTRANET" title="Crash-Cap" description="稳定的平台入口 · 崩溃事故发现、分析与符号健康工作台" extra={<Space wrap><Link to={routePaths.platformArtifacts}><Button>产物与符号</Button></Link><Link to={routePaths.workspaces}><Button icon={<PlusOutlined />}>管理 Workspace</Button></Link><Link to={routePaths.platformUpload}><Button type="primary" icon={<CloudUploadOutlined />}>上传文件</Button></Link></Space>} />
