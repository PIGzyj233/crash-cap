...
ignored paths. Sanitized local evidence is written to
`docs/evidence/authorized-real-sample.*`; publish it as a CI artifact when it
needs to outlive the workspace.
